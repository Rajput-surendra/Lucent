    ...
    return   Scaffold(
      ...
      body: SingleChildScrollView(
        child: Container(
          ...
          child: Column(
            children: [
              getprofile == null || getprofile == "" ?Center(child: CircularProgressIndicator()):  Stack(
                  children: [
                    Column(
                      children: [
                        SizedBox(height: 20,),
                        ...
                        SizedBox(height: 2,),
                        Text("${getprofile?.data?.first.username}",style: TextStyle(color: colors.whiteTemp,fontWeight: FontWeight.bold,overflow: TextOverflow.ellipsis,fontSize: 16),),
            ...
            Container(
                ...
                child:  Column(
                  ...
                  children: <Widget>[
                    ...
                    getprofile?.data?.length ==  null || getprofile?.data?.length == "" ?Center(child: CircularProgressIndicator()):  Column(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Container(
                            height: 55,
                            decoration: BoxDecoration(color: colors.whiteTemp,borderRadius: BorderRadius.circular(10)),
                            child: Padding(
                              padding: const EdgeInsets.all(8.0),
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
